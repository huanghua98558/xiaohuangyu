...
print(f"[OCR] ✅ RapidOCR 已加载, node={OCR_NODE_ID}, max_concurrency={OCR_MAX_CONCURRENT_REQUESTS}")
...
def process_image(image_path: str, image_type: str = None):
    try:
        ...
        normalized_image_type = (image_type or '').strip().lower()
        detected_type = None
...
if __name__ == "__main__":
    ...
    print(f"[OCR] 启动服务，端口: {port}, node={OCR_NODE_ID}")
