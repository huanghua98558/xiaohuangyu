  ...
  <div class="yx-page no-tabbar withdraw-page">
    <header class="yx-header center">
      ...
      <div class="yx-header-main">
        ...
        <p class="yx-subtitle">申请提现并查看记录。</p>
      </div>
    ...
    <section class="yx-soft-card">
      <div class="tip-copy">
        ...
        <p>积分不足可先去 <router-link to="/points">积分中心</router-link> 兑换。</p>
      </div>
    </section>

    <section class="yx-hero-card">
      <div class="yx-card-head-bar">
        <h3>当前可提现余额<span class="yx-card-note">提现将在 1-3 个工作日内到账</span></h3>
      </div>
    ...
    <section class="yx-card">
      <div class="yx-card-head-bar">
        <h3>申请提现<span class="yx-card-note">最低提现 10 元</span></h3>
      </div>
    ...
    <section class="yx-card">
      <div class="yx-card-head-bar">
        <h3>提现记录<span class="yx-card-note">审核与打款记录</span></h3>
      </div>
