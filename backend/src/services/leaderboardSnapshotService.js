...
class LeaderboardSnapshotService {
  ...
  async generateWeeklySnapshot() {
    ...
    // 发放奖励
    await this.distributeRewards(snapshot.id, 'weekly', weeklyRankings)
  ...
  async generateMonthlySnapshot() {
    ...
    // 发放奖励
    await this.distributeRewards(snapshot.id, 'monthly', monthlyRankings)
   ...
   * 发放排行榜奖励
   */
  async distributeRewards(snapshotId, type, rankings) {
    // 从系统配置读取奖励值
