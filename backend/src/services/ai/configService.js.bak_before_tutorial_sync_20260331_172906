...
const CONFIG_CATEGORIES = {
  ...
  task_tutorial_qualification_standards: "assistant",
  task_tutorial_positive_comment_examples: "assistant",
  task_tutorial_comment_library: "assistant",
  task_tutorial_copy_tip: "assistant",
