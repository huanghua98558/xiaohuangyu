...
class LeaderboardService {
  ...
  async getRewardConfig() {
    ...
    return {
      weekly: {
        enabled: configs.rank_weekly_reward_enabled !== false,
        rewards: [
          { key: 'top1', label: '第 1 名', subLabel: '榜首奖励', points: toNumber(configs.rank_weekly_top1, 300) },
          { key: 'top2', label: '第 2 名', subLabel: '第二名奖励', points: toNumber(configs.rank_weekly_top2, 100) },
          { key: 'top3', label: '第 3-5 名', subLabel: '前五奖励', points: toNumber(configs.rank_weekly_top3, 50) },
        ],
      },
      monthly: {
        enabled: configs.rank_monthly_reward_enabled !== false,
        rewards: [
          { key: 'top1', label: '第 1 名', subLabel: '榜首奖励', points: toNumber(configs.rank_monthly_top1, 2000) },
          { key: 'top2', label: '第 2 名', subLabel: '第二名奖励', points: toNumber(configs.rank_monthly_top2, 1000) },
          { key: 'top3', label: '第 3-5 名', subLabel: '前五奖励', points: toNumber(configs.rank_monthly_top3, 500) },
        ],
      },
    }
  }
