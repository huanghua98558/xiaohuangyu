...
const KEY_PREFIX = 'adminCaptcha:'
const TTL_SECONDS = 180
const MAX_ATTEMPTS = 5

/** Redis 未配置时的进程内兜底（单机多实例不一致，生产务必配置 Redis） */
...
/**
 * 生成新验证码，返回 id 与 SVG 字符串（前端 data: URL 展示）
 */
