...
class UserController {
  ...
  async register(req, res, next) {
    try {
      const { username, password, phone, inviteCode, agreedToPrivacy, agreedToTerms } = req.validatedData || req.body
      ...
      const result = await userService.register(username, password, phone, agreements)
  ...
  async login(req, res, next) {
    let username = ''
    try {
      username = (req.validatedData || req.body).username
