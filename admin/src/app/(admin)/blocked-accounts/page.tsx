        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">
              {stats.suspected || stats.byStatus?.suspected || 0}
            </div>
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">
              {stats.false_positive || stats.byStatus?.false_positive || 0}
            </div>
          </CardContent>
        </Card>
      </div>
                  ...
                  <TableRow key={account.id}>
                    <TableCell>
                      <div>
                        <div className="font-medium">
                          {account.user_username || account.user_phone || '-'}
                        </div>
                    ...
                    <TableCell>
                      <div className="max-w-[200px] truncate" title={account.detection_reason}>
                        {account.review_note || account.detection_reason || '-'}
                      </div>
                    </TableCell>
                    <TableCell>{account.occurrence_count || account.detection_count || 1}</TableCell>
                    <TableCell>
